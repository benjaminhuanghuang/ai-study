'''
    To find the probility of one sampel beloes to a category
    function g is called the sigmoid function or logistic function

    reference
        http://www.cnblogs.com/sumai/p/5221067.html
'''
